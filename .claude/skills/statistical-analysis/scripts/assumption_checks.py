...
def check_normality(
    ...
    if plot:
        ...
        ax2.hist(
            data_clean, bins="auto", density=True, alpha=0.7, color="steelblue", edgecolor="black"
        )
...
def check_normality_per_group(
    data: pd.DataFrame, value_col: str, group_col: str, alpha: float = 0.05, plot: bool = True
) -> pd.DataFrame:
    """
...
def comprehensive_assumption_check(
    data: pd.DataFrame, value_col: str, group_col: Optional[str] = None, alpha: float = 0.05
) -> Dict:
    """
