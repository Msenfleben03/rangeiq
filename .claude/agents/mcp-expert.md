...
```json
{
  "mcpServers": {
    "ServiceName MCP": {
      ...
      "env": {
        "API_KEY": "required-env-var",  # pragma: allowlist secret
...
```json
{
  "mcpServers": {
    "Stripe Integration MCP": {
      ...
      "env": {
        "STRIPE_SECRET_KEY": "sk_test_your_key_here",  # pragma: allowlist secret
        "STRIPE_WEBHOOK_SECRET": "whsec_your_webhook_secret",  # pragma: allowlist secret
